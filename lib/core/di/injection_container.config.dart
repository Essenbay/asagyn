...
import '../../feat/profilemenu/pages/profile_detail/logic/change_profile_bloc.dart'
    as _i19;
import '../../feat/session/logic/session_repository.dart' as _i15;
import '../services/app_status/app_bloc.dart' as _i16;
import '../services/language_provder/language_cubit.dart' as _i12;
import '../services/network/interceptors/handler_interceptor.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i11.HandlerInterceptor>(
        () => _i11.HandlerInterceptor(gh<_i9.SecureStorage>()));
    gh.factory<_i12.LanguageCubit>(
        () => _i12.LanguageCubit(gh<_i4.PreferencesService>()));
    gh.singleton<_i13.NetworkService>(_i13.NetworkService(
      gh<_i14.Dio>(),
      gh<_i11.HandlerInterceptor>(),
      gh<_i3.NetworkLoggerInterceptor>(),
    ));
    gh.lazySingleton<_i15.SessionRepository>(() => _i15.SessionRepositoryImpl(
          service: gh<_i13.NetworkService>(),
          prefs: gh<_i4.PreferencesService>(),
        ));
    gh.factory<_i16.AppBloc>(() => _i16.AppBloc(
          gh<_i13.NetworkService>(),
          gh<_i9.SecureStorage>(),
          gh<_i4.PreferencesService>(),
        ));
    gh.lazySingleton<_i17.AuthDatasource>(
        () => _i17.AuthRepositoryImpl(network: gh<_i13.NetworkService>()));
    ...
    gh.factory<_i22.MySessionsBloc>(
        () => _i22.MySessionsBloc(gh<_i15.SessionRepository>()));
    gh.factory<_i23.SessionOrdersBloc>(
        () => _i23.SessionOrdersBloc(gh<_i15.SessionRepository>()));
